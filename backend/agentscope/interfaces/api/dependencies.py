"""Dépendances FastAPI dérivées du conteneur de composition.

Les routes (EPIC 4) importent ces alias `Depends` ; elles n'instancient jamais
d'adaptateur elles-mêmes.
"""
