...
L'URL de base vient des settings applicatifs (``AGENTSCOPE_DATABASE_URL``) sauf si
elle est déjà fixée dans la config (utile pour les tests, qui migrent une SQLite
temporaire).
"""
